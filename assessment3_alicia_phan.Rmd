...
pacman::p_load(rio, here, tidyverse, dplyr, RColorBrewer, cowplot, ggpubr, gghighlight, grid, scales, skimr)
...
## Recreating two figures (age and gender, ethnicity and gender) {.tabset}
...
In addition, there is a notable observation where male patients have higher blood pressure for younger age groups around 20 - 30 years old. [@caliendo2008]
